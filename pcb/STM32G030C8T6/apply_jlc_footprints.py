...
def instance_wrap(fp_name: str, at: tuple[float, float], rot: float,
    ...
    return (
        f'\t(footprint "STM32G030C8T6:{fp_name}"\n'
        f'\t\t(layer "F.Cu")\n'
        f'\t\t(uuid "{uid()}")\n'
...
def apply_sch() -> None:
    ...
    t = t.replace(
        '(property "Footprint" "STM32G030C8T6:MP1584EN_SOT23-8"',
        '(property "Footprint" "STM32G030C8T6:MP1584EN_SOIC-8-EP"',
    )
    t = t.replace(
        """	(global_label "+24V"
		(shape input)
    ...
    pin8 = (
        ...
        '\t\t\t)\n'
        '\t\t)\n'
        '\t(symbol "STM32G030C8T6:TMC2209_StepStick"'
    )
    pin8_new = (
        '\t\t\t\t(pin passive line\n'
        '\t\t\t\t\t(at -5.08 -8.89 0)\n'
    ...
    tmc = '\t(symbol (lib_id "STM32G030C8T6:TMC2209_StepStick") (at 787.4 43.18 0) (unit 1)'
    extra = (
        '\t(global_label "GND"\n'
        '\t\t(shape input)\n'
        '\t\t(at 716.28 182.88 0)\n'
        ...
        '\t)\n'
        '\t(symbol (lib_id "STM32G030C8T6:GEN_R_0805_100k") (at 762 182.88 0) (unit 1)\n'
        ...
        '\t\t\t(effects (font (size 1.27 1.27))))\n'
        '\t\t(property "Footprint" "STM32G030C8T6:R_0805_100k" (at 762 182.88 0)\n'
    ...
    idx = t.find('(symbol "STM32G030C8T6:GEN_R_0805_10k"')
    idx2 = t.find('(symbol "STM32G030C8T6:GEN_R_1206_22R"', idx)
    if idx2 < 0:
        raise SystemExit("cannot insert R_0805_100k lib")
    if '(symbol "STM32G030C8T6:GEN_R_0805_100k"' not in t:
        lib100 = (
            '(symbol "STM32G030C8T6:GEN_R_0805_100k"\n'
            '\t\t\t(pin_numbers (hide no))\n'
            ...
            '\t\t\t(property "Footprint" "STM32G030C8T6:R_0805_100k" (at 0 0 0) (effects (font (size 1.27 1.27)) (hide yes)))\n'
    ...
    for ref, val in CAP_VALUES.items():
        ...
        t = re.sub(
            rf'(\(property "Reference" "{ref}"[\s\S]{{0,700}}\(property "Footprint" ")STM32G030C8T6:CP_SMD_D6\.3x5\.8',
            rf'\g<1>STM32G030C8T6:CP_SMD_D6.3x8',
            t,
            count=1,
        )
