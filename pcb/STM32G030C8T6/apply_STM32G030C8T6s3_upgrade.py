...
'''
    ...
    body = body.replace('STM32G030C8T6:L298N_Module', 'STM32G030C8T6:DRV8871_Module')
    body = body.replace('STM32G030C8T6:DRV8871_Module', 'STM32G030C8T6:DRV8871_Module')  # noop if already
