...
def write_footprint() -> Path:
    ...
    a('\t(version 20260206)')
    a('\t(generator "gen_STM32G030C8T6_30pin_libs.py")')
...
def write_symbol() -> Path:
    ...
    a("\t\t\t(effects (font (size 1.27 1.27)))")
    a("\t\t)")
    a('\t\t(property "Footprint" "STM32G030C8T6:ESP32_DevKit_V1_30Pin_Socket"')
    a("\t\t\t(at 0 0 0)")
    a("\t\t\t(hide yes)")
    a("\t\t\t(effects (font (size 1.27 1.27)))")
    a("\t\t)")
...
def write_schematic() -> Path:
    ...
    sym_path = LIB / "STM32G030C8T6.kicad_sym"
    ...
    emb: list[str] = []
    e = emb.append
    e('\t\t(symbol "STM32G030C8T6:ESP32_DevKit_V1_30Pin"')
    ...
    e("\t\t\t\t(effects (font (size 1.27 1.27)))")
    e("\t\t\t)")
    e('\t\t\t(property "Footprint" "STM32G030C8T6:ESP32_DevKit_V1_30Pin_Socket"')
    e("\t\t\t\t(at 0 0 0)")
    e("\t\t\t\t(hide yes)")
    e("\t\t\t\t(effects (font (size 1.27 1.27)))")
    e("\t\t\t)")
    ...
    lines = [
        "(kicad_sch",
        "\t(version 20250114)",
        '\t(generator "gen_STM32G030C8T6_30pin_libs.py")',
        ...
        *emb,
        "\t)",
        f'\t(symbol (lib_id "STM32G030C8T6:ESP32_DevKit_V1_30Pin") (at 127 101.6 0) (unit 1)',
        f'\t\t(uuid "{sym_uuid}")',
        ...
        "\t\t\t(effects (font (size 1.27 1.27)))",
        "\t\t)",
        '\t\t(property "Footprint" "STM32G030C8T6:ESP32_DevKit_V1_30Pin_Socket" (at 127 101.6 0)',
...
def write_pcb() -> Path:
    ...
    a('\t(footprint "STM32G030C8T6:ESP32_DevKit_V1_30Pin_Socket"')
    a('\t\t(layer "F.Cu")')
    a(f'\t\t(uuid "{uid()}")')
    a(f"\t\t(at {fx} {fy})")
...
| File | Mô tả |
|------|--------|
| `libraries/STM32G030C8T6.kicad_sym` | Symbol `ESP32_DevKit_V1_30Pin` |
| `libraries/STM32G030C8T6.pretty/ESP32_DevKit_V1_30Pin_Socket.kicad_mod` | Footprint ổ cắm |
...
Mở `STM32G030C8T6.kicad_pro` bằng KiCad 10.

Tái tạo lib nếu sửa pinout:

```
python gen_STM32G030C8T6_30pin_libs.py
```
"""
    out = ROOT / "README.md"
